...
public class LocalBuildCommand extends BuildCommand {
    ...
    @Inject public LocalBuildCommand(ISourceTextService sourceTextService, IDependencyService dependencyService,
        ...
        ProjectPathDelegate projectPathDelegate, LanguagesDelegate languagesDelegate) {
        super(sourceTextService, dependencyService, languagePathService, runner, projectPathDelegate);
