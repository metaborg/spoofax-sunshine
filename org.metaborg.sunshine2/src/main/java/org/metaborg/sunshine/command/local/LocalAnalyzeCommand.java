...
public class LocalAnalyzeCommand extends AnalyzeCommand {
    ...
    @Inject public LocalAnalyzeCommand(ISourceTextService sourceTextService, INewDependencyService dependencyService,
                                       INewLanguagePathService languagePathService, ISpoofaxProcessorRunner runner, IStrategoCommon strategoCommon,
                                       LanguageSpecPathDelegate languageSpecPathDelegate, InputDelegate inputDelegate, LanguagesDelegate languagesDelegate) {
