...
public class MessageExtractorLink extends ALinkManyToMany<AnalysisFileResult<IStrategoTerm, IStrategoTerm>, IMessage> {
    private static final Logger logger = LoggerFactory.getLogger(MessageExtractorLink.class.getName());

    @Override public MultiDiff<IMessage> sinkWork(MultiDiff<AnalysisFileResult<IStrategoTerm, IStrategoTerm>> input) {
