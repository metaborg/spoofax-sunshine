...
public class LaunchConfiguration {
    ...
    @Inject public LaunchConfiguration(SunshineMainArguments mainArguments, IResourceService resourceService) {
        ...
        try {
            ...
            throw new RuntimeException("Can't resolve or create cache directory", e);
        }
    }
}
