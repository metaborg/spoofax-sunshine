...
public class MessageHelper {
	...
	final Context context = RuntimeService.INSTANCE().getRuntime(file)
		.getCompiledContext();
	...
	for (IStrategoTerm msg : processedMsgs.getAllSubterms()) {
	    ...
	    final Message resMsg = newAnalysisMessage(file.getPath(), left,
     ...
     * its subterms, doing a depth-first search.
     */
