...
public class MessageHelper {
	public static Collection<IMessage> makeMessages(File file, MessageSeverity severity, IStrategoList msgs) {
		...
		for (IStrategoTerm msg : processedMsgs.getAllSubterms()) {
			...
			final Message resMsg = newAnalysisMessage(file.getPath(), left, right, message, severity);
			result.add(resMsg);
		}
