 ...
 * Interpreters. Precisely one interpreter per languge is cached; subsequent
 * requests for new interpreters are based on the cached ones as prototypes.
 * 
...
public class RuntimeService {
     ...
     * The produced interpreter is based on an internally cached interpreter
     * instance for the given language. If such a cache does not exist, then
     * this method first creates an internal cache for the language and then
     * returns a new interpreter based on that prototype. Note therefore that
	...
	case JAR_NATURE:
	    ...
	    break;
	default:
	    throw new RuntimeException("Unsupported language nature "
		    + lang.getNature());
	}
	...
	throw new RuntimeException(
		"CTree-based compilers are not supported yet");
    }
