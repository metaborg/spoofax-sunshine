...
public class BuilderInputTerm {
    ...
    public BuilderInputTerm(ITermFactory factory, IStrategoTerm ast, File file,
	    File project) {
	this(factory, ast, factory.makeList(), ast, file, project);
    }

    public BuilderInputTerm(ITermFactory factory, IStrategoTerm node,
	    IStrategoList position, IStrategoTerm ast, File file, File project) {
	...
	return termFactory.makeTuple(
		...
		position,
		ast,
		termFactory.makeString(project.toURI().relativize(file.toURI())
			.toString()),
